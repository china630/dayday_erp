...
export const pagesToScreenshot: ScreenshotPage[] = [
  ...
  { path: "/inventory/transfer", fileName: "028-inventory-transfer-page", sourceSlug: "/inventory/transfer" },
  { path: "/inventory/transfer", fileName: "029-modal-inventory-transfer", sourceSlug: "modal/inventory-transfer" },
